...
public class Robot extends TimedRobot {
  ...
  MotorController arm = new CANSparkMax(5, MotorType.kBrushless);
  ...
  public void teleopPeriodic() {
    ...
    if(armController.getRawButtonPressed(1) && !armUp){
      lastBurstTime = Timer.getFPGATimestamp();
      armUp = true;
    }
    else if(armController.getRawButtonPressed(8) && armUp){
      lastBurstTime = Timer.getFPGATimestamp();
      armUp = false;
    }  
